...
const CameraTracker = props => {
    ...
    return (
        <div style={style}>
            <svg className="bi bi-camera" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor"
...
const CameraMouseTracker = withMouseTracker(CameraTracker);

export default CameraMouseTracker;
